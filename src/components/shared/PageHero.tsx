...
// on load (CSS animation — stays a server component).
    ...
    <section className="relative overflow-hidden bg-msc-teal-light/60">
      ...
      <div className="container relative py-16 md:py-20">
        <div className="max-w-3xl">
          {eyebrow && (
            <p className="animate-enter inline-block text-xs font-bold uppercase tracking-widest text-msc-teal bg-white/80 rounded-full px-3.5 py-1.5 mb-5">
              {eyebrow}
            </p>
          )}
