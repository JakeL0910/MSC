        ...
        <div className="container mx-auto max-w-6xl">
          <div className="bg-white rounded-2xl border border-gray-100 p-7 flex flex-col sm:flex-row items-center gap-6">
            <div className="flex-1">
              ...
              <h3 className="text-base font-bold text-msc-charcoal mb-1">MSC Partnership Guide (PDF)</h3>
              <p className="text-sm text-gray-600">Print-ready one-pager covering partnership types, what MSC provides, and how to get started. Bring it to your next meeting.</p>
            </div>
            <div className="flex gap-3 flex-shrink-0">
              <a
                href="/downloads/partnership-guide.pdf"
